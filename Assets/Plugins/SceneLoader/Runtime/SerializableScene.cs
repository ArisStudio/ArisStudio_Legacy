...
namespace ArisStudio.Utils
{
    ...
    public class SerializableScene : ISerializationCallbackReceiver
    {
        ...
        [Tooltip(
            "The name of the referenced scene. This may be used at runtime to load the scene."
        )]
        ...
        private void ValidateScene()
        {
            ...
            if (!_isSceneEnabledInBuildSettings)
                throw new SceneLoadException(
                    $"Scene {SceneName} is not enabled in the build settings"
                );
        }
        ...
        public static implicit operator string(SerializableScene serializableScene)
        {
            ...
            return System.IO.Path.GetFileNameWithoutExtension(
                UnityEditor.AssetDatabase.GetAssetPath(serializableScene.Scene)
            );
#else
        ...
        public void OnBeforeSerialize()
        {
            ...
            if (Scene != null)
            {
                ...
                UnityEditor.EditorBuildSettingsScene[] scenes = UnityEditor
                    .EditorBuildSettings
                    .scenes;
