...
namespace ArisStudio.UtilsEditor
{
    /// <summary>
    ...
    public class SerializableScenePropertyDrawer : PropertyDrawer
    {
        ...
        private void CacheProperties(SerializedProperty property)
        {
            ...
            isSceneEnabledInBuildSettings = property.FindPropertyRelative(
                "_isSceneEnabledInBuildSettings"
            );
        ...
        private void DisplaySceneErrorPrompt(string message)
        {
            ...
            {
                int newCount =
                    sceneIndexInBuildSettings.intValue < 0 ? scenes.Length + 1 : scenes.Length;
